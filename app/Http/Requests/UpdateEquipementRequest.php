...
class UpdateEquipementRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'type_emplacement' => 'sometimes|required|string|max:50',
            'site' => 'sometimes|required|string|max:50',
            'emplacement' => 'sometimes|required|string|max:50',
            'lot' => 'sometimes|required|string|max:20',
            'code_ref' => 'sometimes|required|string|max:50|unique:equipements,code_ref,' . $this->route('equipement'),
